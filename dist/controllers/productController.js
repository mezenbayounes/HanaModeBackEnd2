...
exports.toggleProductVisibility = exports.getProductsByCategory = exports.deleteProduct = exports.updateProduct = exports.createProduct = exports.getProduct = exports.listProducts = void 0;
...
const listProducts = async (req, res) => {
    try {
        ...
        const whereClause = isAdmin ? {} : { isHidden: { [sequelize_1.Op.ne]: true } };
...
const getProductsByCategory = async (req, res) => {
    try {
        ...
        const products = await Product_1.Product.findAll({ where: { category } });
